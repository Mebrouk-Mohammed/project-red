...
func InitMonsters() {
	serpent := &Monster{
		...
		X:          1300,
		Y:          75,
		Sprites:    loadAndScale([]string{"src/assets/serpent1.png"}, 0.07),
		Speed:      1.5,
		LastUpdate: time.Now(),
		Health:     200,
		Damage:     15,
	...
	scorpion := &Monster{
		...
		X:          220,
		Y:          350,
		Sprites:    loadAndScale([]string{"src/assets/scorpion1.png"}, 0.20),
		Speed:      2,
		LastUpdate: time.Now(),
		Health:     100,
		Damage:     5,
	...
	hyene := &Monster{
		...
		X:          350,
		Y:          650,
		Sprites:    loadAndScale([]string{"src/assets/hyene1.png"}, 0.20),
		Speed:      1,
		LastUpdate: time.Now(),
		Health:     400,
		Damage:     25,
